...
class Linear(nn.Linear, LoraLayer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not globals.search: 
            r=globals.r_list[globals.cnt_r]
            globals.cnt_r+=1
        ...
        self.a=torch.zeros(self.r[self.active_adapter],requires_grad=True,device='cuda')
        #print('Linear r='+str(r))
            ...
            if globals.search:
                result += (
                    self.lora_B[self.active_adapter](
                        self.lora_A[self.active_adapter](self.lora_dropout[self.active_adapter](x))* torch.nn.functional.softmax(self.a,dim=0)
                    )
