...
class RobertaSelfAttention(nn.Module):
    ...
    def forward(
        ...
        alpha_q,alpha_v=alpha[:self.lora_r],alpha[self.lora_r:]
        mixed_query_layer = self.query(hidden_states,alpha_q)
        ...
        if is_cross_attention and past_key_value is not None:
            ...
            value_layer = self.transpose_for_scores(self.value(encoder_hidden_states,alpha_v))
            attention_mask = encoder_attention_mask
        elif past_key_value is not None:
            key_layer = self.transpose_for_scores(self.key(hidden_states))
            value_layer = self.transpose_for_scores(self.value(hidden_states,alpha_v))
